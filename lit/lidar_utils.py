...
def crop_points(points, x_min, y_min, z_min, x_max, y_max, z_max, invert=False):
    def get_crop_indices(points, x_min, y_min, z_min, x_max, y_max, z_max, invert):
        ...
        if invert:
            crop_indices = np.setdiff1d(np.arange(len(points)), crop_indices)

        return crop_indices

    indices = get_crop_indices(
        points, x_min, y_min, z_min, x_max, y_max, z_max, invert=invert
    )
