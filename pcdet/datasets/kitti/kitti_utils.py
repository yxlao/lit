...
from pcdet.datasets.dataset import DatasetTemplate as Dataset
from pcdet.utils import box_utils


def transform_annotations_to_kitti_format(
    annos, map_name_to_kitti=None, info_with_fakelidar=False, **kwargs
):
    """
    Args:
        annos:
    ...
    for anno in annos:
        ...
        if kwargs.get("GT_FILTER", None) and kwargs.get("RANGE_FILTER", None):
            ...
            gt_boxes_lidar = filter_by_range(
                anno, gt_boxes_lidar, point_cloud_range, kwargs["is_gt"]
            )
